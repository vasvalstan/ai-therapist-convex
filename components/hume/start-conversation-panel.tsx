...
export function StartConversationPanel() {
  ...
  const isOnSpecificChatPage =
    pathname && pathname !== "/chat/history" && pathname.startsWith("/chat/");
    ...
    try {
      ...
      const result = await createSession({
        initialMessage: {
          ...
          role: "ASSISTANT",
          messageText:
            "Hi, I'm Sereni, your AI therapist. I'm here to listen and help you process your thoughts and feelings. What's on your mind today?",
          content:
            "Hi, I'm Sereni, your AI therapist. I'm here to listen and help you process your thoughts and feelings. What's on your mind today?",
          timestamp: Date.now(),
        },
      ...
      if (!sessionIdentifier) {
        ...
        throw new Error(
          "Failed to create chat session: No session identifier in response"
        );
      }
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-6 px-4 py-8 md:gap-8 md:p-8">
      ...
      <div className="text-center space-y-2 max-w-[600px]">
        ...
        <p className="text-base md:text-xl text-muted-foreground">
          Your AI therapist, ready to listen and help process your thoughts and
          feelings.
        </p>
      </div>
